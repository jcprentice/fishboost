...
data_set <- glue("sim-donor_links1-{x}{y}",
...
protocol <- rbind(
    ...
    data.table(description = "Sim FB Trial 1, SEIDR, donor I[LDR]",
               setup = "fb1",
               label = "s1b",
               donor_fe = "lidr",
    ...
    data.table(description = "Sim FB Trial 1, SEIDR, donor LIDR, 4 events",
               setup = "fb1",
               label = "s1d",
               donor_fe = "lidr",
               sim_link_donor = "slidr",
