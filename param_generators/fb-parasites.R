...
# Variable parameters ----
protocol <- rbind(
    data.table(description = "FB Trial 1, SEIDR, parasites SEI, Traits SIR, FEs LIDR, GE 0.1",
               setup = "fb1",
               use_parasites = "SEI"),
    
    data.table(description = "FB Trial 2, SEIDR, parasites SEI, Traits SIR, FEs LIDR, GE 0.1",
               setup = "fb2",
               use_parasites = "SEI"),
    
    data.table(description = "FB Trial 1+2, SEIDR, parasites SEI, Traits SIR, FEs LIDR, GE 0.1",
               setup = "fishboost",
               use_parasites = "SEI"),
    
    data.table(description = "FB Trial 1, SEIDR, parasites SEI, Traits SIR, FEs LIDR, GE 0.1, narrow priors",
               setup = "fb1",
               use_parasites = "SEI",
               prior__detection_period_val2 = 100,
               prior__cov_G_ss__val2 = 4,
               prior__cov_G_ii__val2 = 4,
               prior__cov_G_rr__val2 = 4),
    
    data.table(description = "FB Trial 2, SEIDR, parasites SEI, Traits SIR, FEs LIDR, GE 0.1, narrow priors",
               setup = "fb2",
               use_parasites = "SEI",
               prior__detection_period_val2 = 100,
               prior__cov_G_ss__val2 = 4,
    ...
    data.table(description = "FB Trial 1+2, SEIDR, parasites SEI, Traits SIR, FEs LIDR, GE 0.1, narrow priors",
               setup = "fishboost",
               use_parasites = "SEI",
               prior__detection_period_val2 = 100,
               prior__cov_G_ss__val2 = 4,
