...
# Variable parameters ----
protocol <- rbind(
    data.table(description = "Sim FB Trial 1, SEIDR, donor LIDR",
               setup = "fb1",
               label = "s1a",
               donor_fe = "lidr",
    ...
    data.table(description = "Sim FB Trial 1, SEIDR, donor LIDR, large FEs",
               setup = "fb1",
               label = "s1b",
               donor_fe = "lidr",
    ...
    data.table(description = "Sim FB Trial 1, SEIDR, donor LIDR, fixed LP",
               setup = "fb1",
               label = "s1c",
               donor_fe = "lidr",
               sim_link_donor = "slidr",
    ...
    data.table(description = "Sim FB Trial 1, SEIDR, donor LIDR, large FEs, fixed LP",
               setup = "fb1",
               label = "s1d",
               donor_fe = "lidr",
               sim_link_donor = "slidr",
