...
protocol <- rbind(
    data.table(description = "Sim FB Trial 1, SEIDR, traits SIR, cov 0, donor LIDR",
               setup = "fb1",
               label = "s1a",
               use_traits = "sir",
               link_traits = "slidr",
    ...
    data.table(description = "Sim FB Trial 1, SEIDR, traits SI, cov 0, donor LIDR",
               setup = "fb1",
               label = "s1b",
               use_traits = "si",
               link_traits = "slidr",
    ...
    data.table(description = "Sim FB Trial 1, SEIDR, traits I, cov 0, donor LIDR",
               setup = "fb1",
               label = "s1c",
               use_traits = "i",
               link_traits = "slidr",
...
replace_NAs("quench", params$quench)
replace_NAs("quench_power", params$quench_power)
replace_NAs("sire_version", params$sire_version)
replace_NAs("nthreads", params$nthreads)
...
message(glue("protocol file '{data_set}' has {nrow(protocol)} rows * {ncol(protocol)} cols"))
