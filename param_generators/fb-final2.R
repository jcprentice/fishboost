...
protocol <- rbind(
    ...
    # GRMs
    data.table(d = "FB,       Traits SIT,   FEs ILDT, Weight nested, GRM"), # 3
    data.table(d = "FB,       Traits SITTT, FEs ILDT, Weight nested, GRM"), # 4
    # GRMs
    data.table(d = "FB, SIDR, Traits SIT,   FEs ILDT, Weight nested, GRM"), # 5
    data.table(d = "FB, SIDR, Traits SITTT, FEs ILDT, Weight nested, GRM"), # 6
