...
# Variable parameters ----
protocol <- rbind(
    data.table(description = "FB_12, Traits SIT, FEs ILDT, LP 0, Fix Seeders, GRM"), # 1
    data.table(description = "FB_12, Traits SIT, FEs ILDT, LP 2, Fix Seeders, GRM"), # 2
    data.table(description = "FB_12, Traits SIT, FEs ILDT, LP 4, Fix Seeders, GRM"), # 3
    data.table(description = "FB_12, Traits SIT, FEs ILDT, LP 6, Fix Seeders, GRM"), # 4
    data.table(description = "FB_12, Traits SIT, FEs ILDT, LP 8, Fix Seeders, GRM"), # 5
    data.table(description = "FB_12, Traits SIT, FEs ILDT, LP 10, Fix Seeders, GRM"), # 6
    
    data.table(description = "FB_12, Traits SI[LDT], FEs ILDT, LP 0, Fix Seeders, GRM"), # 7
    data.table(description = "FB_12, Traits SI[LDT], FEs ILDT, LP 2, Fix Seeders, GRM"), # 8
    data.table(description = "FB_12, Traits SI[LDT], FEs ILDT, LP 4, Fix Seeders, GRM"), # 9
    data.table(description = "FB_12, Traits SI[LDT], FEs ILDT, LP 6, Fix Seeders, GRM"), # 10
    data.table(description = "FB_12, Traits SI[LDT], FEs ILDT, LP 8, Fix Seeders, GRM"), # 11
...
protocol[, `:=`(prior__latent_period__val1 = f(description),
                prior__latent_period__val2 = f(description) + 2),
         by = .I]


# Set samples etc. for pedigree vs GRM
protocol[, nsample := 2.5e4]
